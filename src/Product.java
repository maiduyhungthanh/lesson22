...
public class Product {
    public static Collection getAmountSale;
    private String id;
    private String name;
    ...
    public static String formatMoney(long money){
        DecimalFormat formatter = new DecimalFormat("###,###,##0VNĐ");
        //100000->100,000.00
    ...
    public String toString() {
        return id + " - " + name + " - " + category.getValue() + " - " + amount + " - Giá :" + formatMoney(price) + " -  SL bán : " + amountSale;
    }
